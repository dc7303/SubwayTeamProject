...
public class OrderDTO {
    ...
    public String toString() {
        return orderId + " | " + orderBreadLength + " | " + orderMenu + " | " + orderExtra + " | " + orderBread + " | "
                + orderSauce + " | " + orderPrice + " | " + orderCalorie + " | " + orderUser + " | " + orderText
                + ", orderIsMyMenu=" + orderIsMyMenu + ", orderQuantity=" + orderQuantity + " | " + orderBasket;
    }
